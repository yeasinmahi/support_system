<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logistic.aspx.cs" Inherits="UI.Others.Logistic" %>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <table class="tbldecoration" style="width:auto; float:left;">
        ...
        <tr class="tblheader"><td style=" height:2px; background-color:#c1bdbd;" colspan="4"> </td></tr>
        <tr ><td style="padding: 15px 0px 0px 5px; font-weight:bold; color:#041174;" colspan="4">Trip Delete :</td></tr>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align:right; padding: 10px 0px 0px 100px"><asp:Button ID="btnDelete" runat="server" class="myButton" Text="Trip Delete" OnClientClick = "ConfirmAll()" /></td>
        </tr>
        <tr ><td style="padding: 15px 0px 0px 5px;" colspan="4"> </td></tr>
