<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemApprovalAFBL.aspx.cs" Inherits="UI.Scm.ItemApprovalAFBL" %>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <tr><td>
        ...
        <table class="tbldecoration" style="width:auto; float:left;">
            ...
            <tr>        
                <td class="tdheight" style="text-align:right;"><asp:Label ID="Label1" CssClass="lbl" runat="server" Text="HML Classification : "></asp:Label></td>
                <td class="tdheight"><asp:TextBox ID="txtHMLClassification" runat="server" CssClass="txtBox"></asp:TextBox></td>        

                <td class="tdheight" style="text-align:right;"><asp:Label ID="Label2" CssClass="lbl" runat="server" Text="GL Code : "></asp:Label></td>
                <td class="tdheight"><asp:TextBox ID="txtGLCode" runat="server" CssClass="txtBox"></asp:TextBox></td> 
            </tr>       
